    ...
    <body>
        ...
        <section id="box-profile">
            ...
            <div class="description">
                ...
                <a href="#"class="button bg-blue" >Resume</a>
            </div>
            <div class="information">
                <div class="data">
                    <p class="field">Avaiability</p>
                    <p id="pAvailability" class="text-gray"><?php echo $avaiability;?></p>
                </div>
                <div class="data">
                    <p class="field">Age</p>
        ...
        <section id="input-form">
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']?>">
                ...
                <div class="form">
                    ...
                    <input id="inpAvaiability" type="text" name="avaiability">
                </div>
                <div class="form">
                    <label>Age</label>
        ...
        <script>
            ...
            function editForm(){
                ...
                var avaiability = document.getElementById("pAvaiability").innerHTML;
                ...
                document.getElementById("inpAvaiability").value = avaiability;
